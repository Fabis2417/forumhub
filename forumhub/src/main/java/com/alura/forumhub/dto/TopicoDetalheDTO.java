...
public record TopicoDetalheDTO(
        Long id,
        String titulo,
        String mensagem,
        ...
        Boolean solucionado, // NOVO CAMPO
        Boolean fechado      // NOVO CAMPO
) {
    ...
    public TopicoDetalheDTO(Topico topico) {
        this(topico.getId(), topico.getTitulo(), topico.getMensagem(), topico.getDataCriacao(),
                ...
                topico.isSolucionado(), // Mapeia o campo solucionado
                topico.isFechado());    // Mapeia o campo fechado
    }
}
